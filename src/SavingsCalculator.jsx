...
// //     const result = Number(monthlyAmount) * 12 * Number(years);
// //     setTotal(result);
// //   };
...
// //         <button type="submit">Calculate Total Savings</button>
// //       </form>

// //       {total !== null && (
// //         <div className="result">
// //           <h3>Total Saved Amount</h3>
// //           <p>₹ {total}</p>
// //         </div>
// //       )}
// //     </div>
...
// //     const annualIncome = Number(packageLPA) * 100000; // LPA to yearly income
// //     const monthlyIncome = annualIncome / 12;

// //     const monthlySaving = (monthlyIncome * Number(savingPercent)) / 100;
// //     const yearlySaving = monthlySaving * 12;
// //     const totalSaving = yearlySaving * Number(years);
...
// //           <p>Monthly Income: ₹ {result.monthlyIncome.toFixed(2)}</p>
// //           <p>Monthly Saving: ₹ {result.monthlySaving.toFixed(2)}</p>
// //           <p>Yearly Saving: ₹ {result.yearlySaving.toFixed(2)}</p>
// //           <h4>Total Savings after {years} Years</h4>
// //           <h2>₹ {result.totalSaving.toFixed(2)}</h2>
// //         </div>
// //       )}
// //     </div>
// //   );
...
//     // ✅ Auto Deduction = 10%
//     const monthlyDeduction = grossMonthly * 0.1;
...
//           <button type="submit" className="mb-2">Calculate</button>
//           <button type="button" className="reset" onClick={resetForm}>
//             Reset
//           </button>
//         </form>
...
//           <>
//             <div className="result">
//               <h3>Salary & Savings Breakdown</h3>

//               <p><b>Annual Salary:</b> ₹ {result.annualSalary}</p>
//               <p><b>Gross Monthly Salary:</b> ₹ {result.grossMonthly}</p>
//               <p><b>Auto Monthly Deduction (10%):</b> ₹ {result.monthlyDeduction}</p>

//               <p>
//                 <strong>Net Monthly In-Hand:</strong> ₹ {result.netMonthly}
//               </p>

//               <hr />

//               <p><strong>Monthly Saving:</strong> ₹ {result.monthlySaving}</p>
//               <p><b>Yearly Saving:</b> ₹ {result.yearlySaving}</p>

//               <h4>Total Saving After {years} Years</h4>
//               <h2>₹ {result.totalSaving}</h2>
//             </div>

//             {/* ✅ DOUGHNUT CHART */}
//             <div style={{ marginTop: "30px" }}>
//               <h3 style={{ textAlign: "center" }}>
//                 Monthly Income Distribution (Doughnut Chart)
//               </h3>
